...
def generate_launch_description():
    ...
    nav2_yaml_path = os.path.join(get_package_share_directory('localization_server'), 'config', 'amcl_config.yaml')
    
    nav2_amcl_action = Node(
            package='nav2_amcl',
            executable='amcl',
            name='amcl',
            output='screen',
    ...
    rviz_config_file = os.path.join(get_package_share_directory('localization_server'), 'rviz_config', 'localization_rviz_config.rviz')
